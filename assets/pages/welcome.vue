  ...
  <div class="wrapper">
    <div class="warning">
      ...
      <p>
        ...
        <a :href="`https://symfony.com/doc/${docVersion}/debug-mode`">debug mode</a> is enabled.
      </p>
    </div>
    ...
    <div class="container">
      <div class="welcome">
        <div class="logo">
          <svg xmlns="http://www.w3.org/2000/svg" width="112.165" height="112.166">
            <path
        ...
        <h1><small>Welcome to</small> Symfony <span class="version">{{version}}</span> with Inertia and VueJs 3</h1>
      </div>
...
.container {
  position: relative;
  background: radial-gradient(ellipse at bottom, var(--dark-color) 0%, hsl(v-bind('hue'), 20%, 13%) 100%);
...
.status code, .status .status-ready {
  display: none;
}
